...
\newline\newline\Large\rule{3.0cm}{0pt} Now let statistic T be the \textul{approximate} pivot:
...
\newline If two independent samples of size n$_1$ and  n$_2$ are taken from infinite populations so that \textul{X$_1$ and X$_2$ are independent}, binomial random variables with parameters (n$_1$, p$_1$) and (n$_2$, p$_2$).
...
\newline\newline\Large\rule{3.0cm}{0pt} Now let statistic Z be the \textul{approximate} pivot:
\newline
